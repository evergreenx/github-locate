    ...
    <>
      <div className="bg-white p-5 my-11 flex-col  rounded-lg  flex  justify-center items-center mx-auto">
        ...
        <div class="user-details">
          ...
          "
          <buuton className="shadow-amber-100 p-3 mx-auto flex justify-center ite text-white font-bold  bg-black shadow-lg rounded-lg">
            <Link to={data.html_url}>View on Github</Link>
          </buuton>
        </div>
      </div>
    </>
